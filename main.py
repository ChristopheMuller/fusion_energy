...
from estimator import Dummy_MatchingEstimator, Energy_WeightingEstimator, Energy_MatchingEstimator, Optimal_Energy_MatchingEstimator, \
    REstimator, EnergyProg_WeightingEstimator, EnergyProg_MatchingEstimator, OptimalProg_Energy_MatchingEstimator
...
PIPELINES = [
        ...
        # MethodPipeline(
        #     name="Matching_120",
        #     design=FixedRatioDesign(treat_ratio_prior=0.5, target_n_aug=120),
        #     estimator=Energy_MatchingEstimator()
        # ),
        # MethodPipeline(
        #     name="Matching_130",
        #     design=FixedRatioDesign(treat_ratio_prior=0.5, target_n_aug=130),
        #     estimator=Energy_MatchingEstimator()
        # ),
        # MethodPipeline(
        #     name="Matching_140",
        #     design=FixedRatioDesign(treat_ratio_prior=0.5, target_n_aug=140),
        #     estimator=Energy_MatchingEstimator()
        # ),
        # MethodPipeline(
